...
\hypersetup{
  pdftitle={El caso de los incendios forestales en Folgoso do Courel en 2022},
  pdfauthor={Adrián Cidre; Pepe},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{El caso de los incendios forestales en Folgoso do Courel en 2022}
\usepackage{etoolbox}
\makeatletter
...
% Title and subtitle
{{\huge{\bfseries{\nohyphens{El caso de los incendios forestales en
Folgoso do Courel en 2022}}}}\par
}%

\vspace{\betweentitlesubtitle}
{
{\Large{\nohyphens{Curso de incendios}}}\par
}}
...
\newlength{\namelen}
\settowidth{\namelen}{Adrián
Cidre}\setlength{\miniA}{\maxof{\miniA}{\namelen}}\settowidth{\namelen}{Pepe}\setlength{\miniA}{\maxof{\miniA}{\namelen}}
\setlength{\miniA}{\miniA+0.05\textwidth}
\newlength{\miniB}
\setlength{\miniB}{0.99\textwidth - \miniA}
\begin{minipage}{\miniA}
\begin{flushleft}
{\authorstyle{Adrián Cidre\\ Pepe}}
\end{flushleft}
\end{minipage}
\begin{minipage}{\miniB}
\begin{flushright}
{\affiliationstyle{Minnesota Department of Natural Resources
\\
...
\newcommand{\logoblock}{{\includegraphics[width=0.2\paperwidth]{img/logo.png}}
...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, interior hidden, boxrule=0pt, breakable, frame hidden, enhanced, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi
